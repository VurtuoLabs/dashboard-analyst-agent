...
An Agentforce agent that summarises a Salesforce dashboard and the reports behind it.
...
| Control | Count |
|---|---|
| Production Apex classes | 2 |
| Classes declared `with sharing` | 2 |
| Classes declared `without sharing` | 0 |
| Production SOQL queries | 3 |
| Queries carrying an explicit enforcement clause | 3 |
...
- It does not modify dashboards, reports or the records behind them. It is read-only.
- It does not export report data anywhere.
